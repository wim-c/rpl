...
parser.add_argument('-r', '--runtime', dest='rt', metavar='ADDRESS', default=0x9000, type=dex, help='The address where the RPL21 runtime code is located.  Default is 0x9000.')
